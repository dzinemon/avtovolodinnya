...
export default async function markdownToHtml(markdown) {
  ...
  const classNamesH1 = 'leading-relaxed text-4xl font-bold text-gray-900 mt-14 mb-6' 
  const classNamesH2 = 'leading-relaxed text-3xl font-bold text-gray-800 mt-10 mb-6' 
  const classNamesH3 = 'leading-relaxed text-2xl font-bold text-gray-700 mt-8 mb-6' 
  const regexP = /<p>/g;
  const regexH1 = /<h1>/g;
  const regexH2 = /<h2>/g;
  const regexH3 = /<h3>/g;
